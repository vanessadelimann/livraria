...
public class JCliente extends JFrame {
	...
	//JANELA PARA CRIAR CADASTRO DO CLIENTE
	...
	public JCliente() {
		...
		JLabel lblNewLabel = new JLabel("Cadastrar Novo Cliente");
		...
		bConfirma.addActionListener(  
				new ActionListener(){  
					public void actionPerformed(ActionEvent evento){  
						cliente.cadastrarCliente(textFieldNome.getText(),textFieldCpf.getText(), textFieldTelefone.getText(),textFieldEmail.getText(),textFieldRua.getText(),textFieldNum.getText(),textFieldBairro.getText(),textFieldUf.getText(),textFieldCidade.getText(),textFieldCom.getText());
