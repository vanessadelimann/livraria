...
public class JAtualizarLivros extends JFrame {
	
	//ATUALIZAR LIVROS DO ESTOQUE
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JAtualizarLivros frame = new JAtualizarLivros();
	...
	public JAtualizarLivros() {
		...
		JLabel lblNewLabel = new JLabel("Atualizar Dados do Livro");
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 17));
		lblNewLabel.setBackground(Color.WHITE);
		lblNewLabel.setBounds(286, 76, 234, 36);
		...
		textFieldEdicao.setToolTipText("");
		...
		bConfirma.addActionListener(  
				new ActionListener(){  
					public void actionPerformed(ActionEvent evento){  
						livro.atualizarLivro(textFieldNome.getText(), textFieldIsbn.getText(), textFieldEdicao.getText(), textFieldAno.getText(),textFieldAutor.getText(),Integer.parseInt(textFieldPag.getText()), Double.valueOf(textFieldPreco.getText()).doubleValue(),Integer.parseInt(textFieldEstoque.getText()));
